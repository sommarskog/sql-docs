...
:::image type="content" source="media/sql-managed-instance-paas-overview/key-features.png" alt-text="Diagram of Key features for Azure SQL Managed Instance.":::
...
:::row:::
    ...
    **Operational**
    ...
    :::column:::
    **Scenario enablers**
    - [Synchronize data with the Managed Instance link](managed-instance-link-feature-overview.md)
...
:::row:::
    ...
    **Programmability**
    ...
    :::column:::
    **Security**
    - [Microsoft Entra authentication](../database/authentication-aad-overview.md)
...
For a comprehensive list of SQL Server and Azure SQL Managed Instance features, review [features comparison](../database/features-comparison.md).  
...
:::image type="content" source="media/sql-managed-instance-paas-overview/application-deployment-topologies.png" alt-text="Screenshot of High availability." lightbox="media/sql-managed-instance-paas-overview/application-deployment-topologies.png":::
...
The migration approach uses SQL backups to Azure Blob storage. Backups stored in Azure Blob Storage can be directly restored into a managed instance using the [T-SQL RESTORE command](/sql/t-sql/statements/restore-statements-transact-sql?preserve-view=true&view=azuresqldb-mi-current).
