...
This section lists the latest versions of each package per distribution, for [!INCLUDE [ssSQL19](../includes/sssql19-md.md)]. The following table shows the most recent release, which is **CU 30**. For full release history, see [Release history for [!INCLUDE [ssNoVersion](../includes/ssnoversion-md.md)] 2019](/troubleshoot/sql/linux/release-history-2019).

| Version | Release | Date | Build | KB article |
| --- | --- | --- | --- | --- |
| [!INCLUDE [ssSQL19](../includes/sssql19-md.md)] | CU 30 | 2024-12-12 | 15.0.4415.2 | [Support article](/troubleshoot/sql/releases/sqlserver-2019/cumulativeupdate30) |
...
| RHEL 8 | Database Engine | 15.0.4415.2-2 | [Database Engine RPM package](https://packages.microsoft.com/rhel/8/mssql-server-2019/Packages/m/mssql-server-15.0.4415.2-2.x86_64.rpm) |
| RHEL 8 | Extensibility | 15.0.4415.2-2 | [Extensibility RPM package](https://packages.microsoft.com/rhel/8/mssql-server-2019/Packages/m/mssql-server-extensibility-15.0.4415.2-2.x86_64.rpm) |
| RHEL 8 | Full-Text Search | 15.0.4415.2-2 | [Full-Text Search RPM package](https://packages.microsoft.com/rhel/8/mssql-server-2019/Packages/m/mssql-server-fts-15.0.4415.2-2.x86_64.rpm) |
| RHEL 8 | High Availability | 15.0.4415.2-2 | [High Availability RPM package](https://packages.microsoft.com/rhel/8/mssql-server-2019/Packages/m/mssql-server-ha-15.0.4415.2-2.x86_64.rpm) |
| RHEL 8 | Java Extensibility | 15.0.4415.2-2 | [Java Extensibility RPM package](https://packages.microsoft.com/rhel/8/mssql-server-2019/Packages/m/mssql-server-extensibility-java-15.0.4415.2-2.x86_64.rpm) |
| RHEL 8 | PolyBase | 15.0.4415.2-2 | [PolyBase RPM package](https://packages.microsoft.com/rhel/8/mssql-server-2019/Packages/m/mssql-server-polybase-15.0.4415.2-2.x86_64.rpm) |
...
| SLES 15 | Database Engine | 15.0.4415.2-2 | [Database Engine RPM package](https://packages.microsoft.com/sles/15/mssql-server-2019/Packages/m/mssql-server-15.0.4415.2-2.x86_64.rpm) |
| SLES 15 | Extensibility | 15.0.4415.2-2 | [Extensibility RPM package](https://packages.microsoft.com/sles/15/mssql-server-2019/Packages/m/mssql-server-extensibility-15.0.4415.2-2.x86_64.rpm) |
| SLES 15 | Full-Text Search | 15.0.4415.2-2 | [Full-Text Search RPM package](https://packages.microsoft.com/sles/15/mssql-server-2019/Packages/m/mssql-server-fts-15.0.4415.2-2.x86_64.rpm) |
| SLES 15 | High Availability | 15.0.4415.2-2 | [High Availability RPM package](https://packages.microsoft.com/sles/15/mssql-server-2019/Packages/m/mssql-server-ha-15.0.4415.2-2.x86_64.rpm) |
| SLES 15 | Java Extensibility | 15.0.4415.2-2 | [Java Extensibility RPM package](https://packages.microsoft.com/sles/15/mssql-server-2019/Packages/m/mssql-server-extensibility-java-15.0.4415.2-2.x86_64.rpm) |
| SLES 15 | PolyBase | 15.0.4415.2-2 | [PolyBase RPM package](https://packages.microsoft.com/sles/15/mssql-server-2019/Packages/m/mssql-server-polybase-15.0.4415.2-2.x86_64.rpm) |
| **Ubuntu** | | | |
| Ubuntu 20.04 | Database Engine | 15.0.4415.2-2 | [Database Engine Debian package](https://packages.microsoft.com/ubuntu/20.04/mssql-server-2019/pool/main/m/mssql-server/mssql-server_15.0.4415.2-2_amd64.deb) |
| Ubuntu 20.04 | Extensibility | 15.0.4415.2-2 | [Extensibility Debian package](https://packages.microsoft.com/ubuntu/20.04/mssql-server-2019/pool/main/m/mssql-server-extensibility/mssql-server-extensibility_15.0.4415.2-2_amd64.deb) |
| Ubuntu 20.04 | Full-Text Search | 15.0.4415.2-2 | [Full-Text Search Debian package](https://packages.microsoft.com/ubuntu/20.04/mssql-server-2019/pool/main/m/mssql-server-fts/mssql-server-fts_15.0.4415.2-2_amd64.deb) |
| Ubuntu 20.04 | High Availability | 15.0.4415.2-2 | [High Availability Debian package](https://packages.microsoft.com/ubuntu/20.04/mssql-server-2019/pool/main/m/mssql-server-ha/mssql-server-ha_15.0.4415.2-2_amd64.deb) |
| Ubuntu 20.04 | Java Extensibility | 15.0.4415.2-2 | [Java Extensibility Debian package](https://packages.microsoft.com/ubuntu/20.04/mssql-server-2019/pool/main/m/mssql-server-extensibility-java/mssql-server-extensibility-java_15.0.4415.2-2_amd64.deb) |
| Ubuntu 20.04 | PolyBase | 15.0.4415.2-2 | [PolyBase Debian package](https://packages.microsoft.com/ubuntu/20.04/mssql-server-2019/pool/main/m/mssql-server-polybase/mssql-server-polybase_15.0.4415.2-2_amd64.deb) |
...
| ------------------------------------------------------------------------ | ------------- | ------------ |
| [CU 30](/troubleshoot/sql/linux/release-history-2019#CU30)               | 15.0.4415.2   | 2024-12-12   |
| [CU 29 GDR](/troubleshoot/sql/linux/release-history-2019#CU29-GDR)       | 15.0.4410.1   | 2024-11-12   |
| [CU 29](/troubleshoot/sql/linux/release-history-2019#CU29)               | 15.0.4405.4   | 2024-10-31   |
